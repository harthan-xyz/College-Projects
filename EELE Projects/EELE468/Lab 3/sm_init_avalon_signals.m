...
datavals_valid   = zeros(1,mp.Nsampels_avalon);
...
Ndatavals = length(datavls_data); % get number of data points
...
mp.Avalon_Source_Valid    = timeseries(datavlas_valid,timevals);
