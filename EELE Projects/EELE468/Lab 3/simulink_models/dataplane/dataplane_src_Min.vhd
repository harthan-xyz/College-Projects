...
ARCHITECTURE rtl OF dataplane_src_Min IS
  ...
  -- Signals
  SIGNAL Min_muxout0                      : signed(31 DOWNTO 0);  -- sfix32_En28
  SIGNAL Min_muxout1					  : signed(31 DOWNTO 0);  -- sfix32_En28
  SIGNAL Min_stage1_val                   : signed(31 DOWNTO 0);  -- sfix32_En28

BEGIN
  Min_muxout0 <= signed(in0);
  Min_muxout1 <= signed(in1);

  ---- Tree min implementation ----
  ---- Tree min stage 1 ----
  
  Min_stage1_val <= Min_muxout0 WHEN Min_muxout0 <= Min_muxout1 ELSE
      Min_muxout1;
