-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_final\hdlsrc\lab3_p12\dataplane_src_Right_Channel_Processing.vhd
...
-- Source Path: lab3_p12/dataplane/Avalon Data Processing/Right Channel Processing
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  Sound_Effects_out1_bypass <= Sound_Effects_out1_last_value WHEN Enable_out2 = '0' ELSE
