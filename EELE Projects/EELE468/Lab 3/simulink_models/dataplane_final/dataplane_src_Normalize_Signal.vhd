-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_final\hdlsrc\lab3_p12\dataplane_src_Normalize_Signal.vhd
...
-- Source Path: lab3_p12/dataplane/Avalon Data Processing/Left Channel Processing/Signal Energy Monitor/Normalize 
-- Signa
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
...
BEGIN
  ...
  MinMax_stage1_val <= Product1_out1 WHEN Product1_out1 >= Delay_out1 ELSE
      Delay_out1;

  
  Switch_out1 <= MinMax_stage1_val WHEN switch_compare_1 = '0' ELSE
      Constant_out1;
  ...
  Min_stage1_val <= Constant1_out1 WHEN Constant1_out1 <= Product_out1 ELSE
      Product_out1;

  Normalized_Signal_Energy <= std_logic_vector(Min_stage1_val);
